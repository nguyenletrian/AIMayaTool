...
def run_skirt_parent_transfer_smoothing_plan_smoke():
    ...
    parent = cmds.createNode('joint', name='AIMayaToolSkirtTransferSmoothingParent')
    ...
    for index, angle in enumerate((0.0, math.pi * 0.5, math.pi, math.pi * 1.5)):
        joint = cmds.createNode('joint', name='AIMayaToolSkirtTransferSmoothingJoint%d' % index)
    ...
    return 'SKINNING_SKIRT_PARENT_TRANSFER_SMOOTHING_PLAN_SMOKE_OK'
