...
def run_influence_cleanup_smoke():
    ...
    cmds.skinPercent(source_skin, source + '.vtx[0]', transformValue=[(joint_a, 0.5), (joint_b, 0.5)], normalize=True)
    cmds.skinPercent(target_skin, target + '.vtx[0]', transformValue=[(joint_a, 1.0), (joint_unused, 0.0)], normalize=True)
