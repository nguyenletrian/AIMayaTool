...
def run_skirt_parent_transfer_workflow_smoke():
    ...
    parent = cmds.createNode('joint', name='AIMayaToolSkirtTransferWorkflowParent')
    ...
    for index, angle in enumerate((0.0, math.pi * 0.5, math.pi, math.pi * 1.5)):
        joint = cmds.createNode('joint', name='AIMayaToolSkirtTransferWorkflowJoint%d' % index)
    ...
    return 'SKINNING_SKIRT_PARENT_TRANSFER_WORKFLOW_SMOKE_OK'
