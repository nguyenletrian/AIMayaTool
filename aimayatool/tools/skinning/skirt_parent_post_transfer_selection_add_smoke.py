...
def run_skirt_parent_post_transfer_selection_add_smoke():
    import importlib
    import math
    ...
    mesh = cmds.polyCylinder(name='AIMayaToolSkirtPostTransferSelectionAddMesh', radius=2.0, height=3.0, subdivisionsX=8, subdivisionsY=2, subdivisionsZ=1)[0]
    ...
    parent = cmds.createNode('joint', name='AIMayaToolSkirtPostTransferSelectionAddParent')
    ...
    for index, angle in enumerate((0.0, math.pi * 0.5, math.pi, math.pi * 1.5)):
        joint = cmds.createNode('joint', name='AIMayaToolSkirtPostTransferSelectionAddJoint%d' % index)
    ...
    return 'SKINNING_SKIRT_PARENT_POST_TRANSFER_SELECTION_ADD_SMOKE_OK'
